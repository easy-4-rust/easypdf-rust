...
#![deny(unsafe_code)]
#![allow(clippy::cast_possible_truncation, clippy::cast_precision_loss, clippy::doc_markdown, clippy::missing_errors_doc, clippy::redundant_closure_for_method_calls, clippy::needless_borrow, clippy::similar_names, clippy::default_trait_access, clippy::needless_pass_by_value)]
...
mod tests {
    ...
    #[allow(clippy::redundant_closure_for_method_calls, clippy::needless_borrow, clippy::redundant_clone)]
